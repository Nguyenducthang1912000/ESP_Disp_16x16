...
// void task_ssd1306_display_text8x8(const void *arg_text)
// {
...
// 	vTaskDelete(NULL);
// }
void task_ssd1306_display_text16x16_ll(const void *arg_text)
{
	char *text = (char *)arg_text;
	uint8_t text_len = strlen(text);
...
void task_ssd1306_display_text16x16_ff(const void *arg_text)
{
	char *text = (char *)arg_text;
	uint8_t text_len = strlen(text);
